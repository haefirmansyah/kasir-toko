...
?>
  ...
  <head>
    ...
    <title>Bintang Utama Komputer| Edit Jasa </title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Jasa Reparasi</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
          ...
          <div class="container-fluid">
            ...
            <div class="card ">
              ...
              <div class="card-body" style="width:50%;margin:0 auto;">
                <!-- Form Edit -->
                <h2 align="Center" class="m-0 text-dark">Edit Jasa </h2>
                <br>
                <?php

                $tampil = mysqli_query($koneksi, "select * from t_jasa where id_jasa='$_GET[id_jasa]';");
                $d = mysqli_fetch_array($tampil);
                ?>
                <form method="POST" action="edit_jasa.php">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="disabledInput" value="<?php echo "$d[id_jasa]"; ?>" name="id_jasa" readonly>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="inlineFormInputGroup" placeholder="Nama Jasa" name="nama_jasa" value="<?php echo "$d[nama_jasa]"; ?>" required>
                    </div>
