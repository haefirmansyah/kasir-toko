                ...
                <form method="POST" action="edit_kategori.php">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="disabledInput" value="<?php echo "$d[id_kategori]"; ?>" name="id_kategori" readonly>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="inlineFormInputGroup" placeholder="Nama Admin" name="nama_kategori" value="<?php echo "$d[nama_kategori]"; ?>" required>
                    </div>
