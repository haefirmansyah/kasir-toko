      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Jasa Reparasi (Servis)</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
          ...
          <div class="container-fluid">
            ...
            <div class="card ">
              ...
              <div class="card-body" style="width:50%;margin:0 auto;">
                <!-- Form Edit -->
                <h2 align="Center" class="m-0 text-dark">Tambah Jasa Servis </h2>
                <br>

                <form method="POST" action="input_jasa.php">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="disabledInput" value="<?php echo "$idjasa" ?>" name="id_jasa" readonly>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="inlineFormInputGroup" placeholder="Nama Jasa" name="nama_jasa" required>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="number" class="form-control form-control-lg" id="inlineFormInputGroup" placeholder="Harga Jasa" name="harga" required>
                    </div>
                    <div class="input-group mb-2">
                      <div class="input-group-prepend">
