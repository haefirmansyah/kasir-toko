      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Daftar Jasa Service </h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
          ...
          <div class="container-fluid">
            ...
            <div class="card ">
              ...
              <div class="card-header" align="right">
                ...
                <a class="btn btn-primary" href="form_input_jasa.php"><i class="fas fa-plus nav-icon"></i> Tambah</a>
              </div>
              ...
              <div class="card-body" style="width:80%;margin:0 auto;">
                <table id="pelanggan" class="table table-bordered table-striped">
                  ...
                  <tbody align="center">
                    ...
                    $no = 0;
                    $data = mysqli_query($koneksi, "select * from t_jasa inner join t_kategori on t_jasa.id_kategori=t_kategori.id_kategori ");
                    ...
                    ?>
                      <tr>
                        ...
                        <td align="center">
                          <a href='form_edit_jasa.php?id_jasa=<?php echo "$d[id_jasa]"; ?>' class='btn btn-info'> Edit </a>
                          <a class='btn btn-warning' data-toggle='modal' data-target='#konfirmasi_hapus' data-href="hapus_jasa.php?id_jasa=<?php echo "$d[id_jasa]"; ?>">Hapus</a>
