      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="card ">
              <br>
              <h2 align="Center" class="m-0 text-dark">Laporan Penjualan Sparepart</h2>
                ...
                <div class="container">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <form action="laporan-sparepart.php" method="get">
                  ...
                  ?>
                    <div class="panel">
                      <div class="panel-heading">
                        <h4>Data Laporan Penjualan Sparepart dari <b><?php echo $dari; ?></b> sampai <b><?php echo $sampai; ?></b></h4>
                      </div>
                      <div class="panel-body">

                        <a target="_blank" href="cetak_sparepart.php?dari=<?php echo $dari; ?>&sampai=<?php echo $sampai; ?>" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-print"></i> CETAK</a>
