...
<head>
	<title>Sistem Informasi Jasa Reparasi ITC Komputer </title>
		...
		<div class="container">
			...
			<div class="col-md-9 col-md-offset-1" style="background-color:none;border:1px dashed;">
				...
				<table class="table" border="0">
					<tr>
						<td width="30%;">
							<p> <span style="font-size:32px;font-weight:bold;"> Bintang Utama Komputer</span> <span style="font-size:20px;font-weight:bold;font-style:italic;"></span> </p>
