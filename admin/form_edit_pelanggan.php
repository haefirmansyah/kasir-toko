          ...
          <div class="container-fluid">
            ...
            <div class="card ">
              ...
              <div class="card-body" style="width:50%;margin:0 auto;">
                <!-- Form Edit -->
                <h2 align="Center" class="m-0 text-dark">Edit Data Pelanggan</h2>
                <br>
                <?php

                $tampil = mysqli_query($koneksi, "select * from t_pelanggan where id_pelanggan='$_GET[id_pelanggan]';");
                ...
                <form method="POST" action="edit_pelanggan.php">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="disabledInput" value="<?php echo "$d[id_pelanggan]"; ?>" name="id_pelanggan" readonly>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="inlineFormInputGroup" placeholder="Nama Pelanggan" name="nama_pelanggan" value="<?php echo "$d[nama_pelanggan]"; ?>" required>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="number" class="form-control form-control-lg" id="inlineFormInputGroup" placeholder="NO Handphone" name="no_hp" value="<?php echo "$d[no_hp]"; ?>" required>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control form-control-lg" id="inlineFormInputGroup" placeholder="Alamat" name="alamat" value="<?php echo "$d[alamat]"; ?>">
                    </div>
