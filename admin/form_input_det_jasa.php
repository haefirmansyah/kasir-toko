...
?>
  ...
  <head>
    ...
    <title> Bintang Utama Komputer| Jasa </title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Input Jasa (Det)</h1>
          ...
          <div class="container-fluid">
            ...
            <div class="card ">
              ...
              <div class="card-body" style="width:90%;margin:0 auto;">
                <!-- Form servis -->
                <h2 align="Center" class="m-0 text-dark">Jasa Yang Di Beli </h2>
                <br>
                <br>
                ...
                <div class="card ">
                  ...
                  <div class="card " style="border:none;">
                    <div class="card-header">
                      ...
                      <form method="POST" action="input_det_jasa.php">
                        ...
                        <div class="form-group row">
                          <label for="inputEmail3" class="col-sm-2 col-form-label">Jenis Jasa</label>
                          <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                          <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Jasa </label>
                          <div class="col-sm-3">
                            <select class="form-control" id="jasa" name="id_jasa">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <button class="btn btn-outline-success"> Pilih Jasa </button>
                          </div>
                    ...
                    <div class="card-body">
                      ...
                      <table class="table" id="tabel_jasa">
                        ...
                        <tbody align="center">
                          <?php include "../koneksi.php";
                          $no = 0;
                          $data = mysqli_query($koneksi, "select * from t_trans_det_jasa where id_servis='$_GET[id_servis]' ");
                          ...
                          ?>
                            <tr>
                              ...
                              <td align="center">
                                ...
                                <a class='btn btn-warning' data-toggle='modal' data-target='#konfirmasi_hapus' data-href="hapus_det_jasa.php?id_jasa=<?php echo "$d[id_jasa]"; ?>&id_servis=<?php echo "$d[id_servis]"; ?> ">Hapus</a>
                      ...
                      <?php
                      include "../koneksi.php";
                      $jumlahkan = mysqli_query($koneksi, " SELECT SUM(sub_total) as total from t_trans_det_jasa where id_servis='$_GET[id_servis]'");
